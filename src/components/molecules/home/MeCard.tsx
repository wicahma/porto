...
const MeCard = () => {
  ...
  return (
    <m.div
      ...
      className="hoverable h-fit hover:bg-neutral-800 hover:overflow-clip border transition-colors border-transparent hover:border cursor-pointer hover:border-neutral-700 px-3.5 rounded-2xl pt-3"
    >
      <m.div
        className={cn(
      ...
      <div className="text-xl flex justify-between items-center gap-2">
        <div className="relative pl-8 pr-2 py-6 font-bold w-fit h-fit flex items-center justify-center">
          <p className="relative z-10 right-3 bottom-0.5">Hello, I&apos;m</p>
