  ...
  const ExpandedCard = () =>
    createPortal(
      <AnimatePresence>
        {isExpanded && (
          <m.div
            className="fixed bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] border border-[#ABABAB]/20 rounded-2xl shadow-2xl overflow-hidden"
            initial={{
          ...
          >
            <div className="flex h-full">
              ...
              {/* Content Section */}
              <div className="flex-1 py-6 px-3 flex flex-col justify-center">
                <m.div
                ...
                >
                  <p className="text-[#ABABAB] leading-6 mb-4 text-xs">
                    {data.description}
                  </p>
                </m.div>
              </div>
