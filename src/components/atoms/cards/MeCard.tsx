...
const MeCard = () => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-2">
        <h2 className="md:text-7xl text-6xl font-bold relative z-10">
          <FadePull delay={0.5}>
            <span>Software{"\n"}</span>
        ...
        <WordsPull
          ...
          tag="p"
          delay={0.9}
          textClassName="pr-2 md:leading-6 leading-5"
          className="mt-6 text-neutral-700 font-semibold text-lg md:text-xl w-full flex-wrap justify-start"
        />
      </div>
    </m.div>
  );
